    ...
    private void validateMedicalRecordDates (MedicalRecordRequest medicalRecordRequest){
        ...
        if(medicalRecordRepository.findByYear(medicalRecordRequest.getStartDate().getYear())
                ...
                .anyMatch(medicalRecord ->
                        medicalRecord.getStartDate().equals(medicalRecordRequest.getStartDate()) //!!! 1. kontrol : baslama tarihleri ayni ise --> et1(10 kasim 2023) / YeniEt(10 kasim 2023)
                                ||  (medicalRecord.getStartDate().isBefore(medicalRecordRequest.getStartDate())//!!! 2. kontrol : baslama tarihi mevcuttun baslama ve bitis tarihi ortasinda ise -->
                                && medicalRecord.getEndDate().isAfter(medicalRecordRequest.getStartDate())) // Ornek : et1 ( baslama 10 kasim 2023 - bitme 20 kasim 2023)  - YeniEt ( baslama 15 kasim 2023 bitme 25 kasim 2023)
                                ...
                                && medicalRecord.getEndDate().isAfter(medicalRecordRequest.getEndDate())) // Ornek : et1 ( baslama 10 kasim 2023 - bitme 20 kasim 2023)  - YeniEt ( baslama 09 kasim 2023 bitme 15 kasim 2023)
                                ||  (medicalRecord.getStartDate().isAfter(medicalRecordRequest.getStartDate()) //!!!4.kontrol : yeni eklenecek eskiyi tamamen kapsiyorsa
                                && medicalRecord.getEndDate().isBefore(medicalRecordRequest.getEndDate()))//et1 ( baslama 10 kasim 2023 - bitme 20 kasim 2023)  - YeniEt ( baslama 09 kasim 2023 bitme 25 kasim 2023)
